...
console.log(oyun("Taş", "Kağıt")); // "Kaybettin!"
console.log(oyun("Makas", "Kağıt")); // "Kazandın!"
console.log(oyun("Taş", "Taş")); // "Beraberlik"
...
console.log(sesliHarfSayaci("JavaScript çok güzel bir dil")); // 11
